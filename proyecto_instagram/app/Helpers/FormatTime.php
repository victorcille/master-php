<?php
// Este es un helper que nos hemos copiado del blog de Víctor Robles (crear helpers en Laravel 5)
// sirve para poder mostrar las fechas con el formato "hace x días"
